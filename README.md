# Enhancing the Customer Experience of British Airways (2016-2023)
...
-	Data Volume: 1324 valid customer reviews gathered between 2016 and 2023.
	Key Metrics: header, author, date, place, content, aircraft, traveler type, route, date flown, recommended, trip verified, rating, seat comfort, cabin service, food quality, ground service, value for money, and entertainment.
...
•	Data Quality: All 100% of the records were found to be correctly formatted - complete and clean, with no missing data. 
# Methodology
## Data Preparation:
...
- Comparative Analysis: Satisfaction levels were compared across demographics, flight routes, and service categories using DAX measures to assess performance disparities.
  # Findings
## Customer Feedback and Overall Rating
...
## In-Flight Experience: Key Areas for Improvement
...
# Recommendations
## Enhance Seat Comfort for Economy Class
...
## Improve Food Quality Across All Classes
...
## Empowering Cabin Crew with Cross-Cultural Expertise
